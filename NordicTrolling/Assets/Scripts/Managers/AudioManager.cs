...
namespace Managers
{
    public class AudioManager : MonoBehaviour
    {
        ...
        {
            get { return Camera.main.GetComponent<AudioManager>(); }
        }
        ...
        public Sound PlayNewSound(string soundName, bool loop = false, bool interrupts = false,
        ...
        public Sound PlayNewSoundWithCustomPitch(string soundName, float pitch = 1f, bool loop = false, bool interrupts = false,
            Action<Sound> callback = null)
        {
            Sound sound = NewSound(soundName, loop, interrupts, callback);
        ...
        private void Update()
        {
            sounds.ToList().ForEach(sound => { sound.Update(); });
        }
    }
}